...
class Step1X3DTextureConfig:
    def __init__(self):
        ...
        self.base_model = "/my_workspace/models/stable-diffusion-xl-base-1.0"
        self.vae_model = "/my_workspace/models/taesdxl"
        self.bitrefnet = "/my_workspace/models/BiRefNet"
        self.unet_model = None
        self.lora_model = None
        self.adapter_path = "/my_workspace/models/Step1X-3D"
        self.scheduler = None
        self.num_views = 6
    ...
    def __call__(self, image, mesh, remove_bg=True, seed=2025):
        if remove_bg:
            birefnet = AutoModelForImageSegmentation.from_pretrained(
                self.config.bitrefnet, trust_remote_code=True
            )
